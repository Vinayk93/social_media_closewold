...
String content=request.getParameter("statusva");
...
ResultSet rs= stat.executeQuery(query);         
 while(rs.next()){
  out.print("insert into post values('"+rs.getString(1)+"','"+rs.getString(2)+"',now(),'"+content+"',0,'"+userid+"','');");
  Statement stet=conn.createStatement(); 
  String str4="insert into post values('"+rs.getString(1)+"','"+rs.getString(2)+"',now(),'"+content+"',0,'"+userid+"','');";
  stet.execute(str4);
       }
stat.close();
conn.close();
